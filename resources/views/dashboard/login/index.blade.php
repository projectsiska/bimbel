...
<div class="tile">
  <div class="tile-header">
    <h2 style="color: white; opacity: .75; font-size: 4rem; display: flex; justify-content: center; align-items: center; height: 100%; margin-top:0px">LOGIN</h2>
  </div>
  ...
  <div class="tile-body">
    <form  method="post" action="/login">
      ...
      <label class="form-input">
        ...
        <input type="text" autofocus="true"  name="username" required />

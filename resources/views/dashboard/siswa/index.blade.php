...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <a type="button" href="/siswa/create" class="btn btn-primary btn-rounded btn-fw"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="noti-box-list">
                                                <ul>
                                                    <li>
                                                        <a href='/siswa/{{ $posta['id']}}' class="showw">
                                                                <i class="fa fa-eye"></i>
                                                             
                                                        </a> <br>

                                                        <a href='/siswa/{{$posta->id}}/edit' class="edit">
                                                                <i class="fa fa-pencil"></i>
                                                            
                                                        </a> <br>

                                                       
                                                        <form action="/siswa/{{ $posta->id }}" method="post"
                                                            ...
                                                            href='/siswa/{{$posta->id}}/destroy' type="submit" VALUE="X" class="delete">
                                                        </form>

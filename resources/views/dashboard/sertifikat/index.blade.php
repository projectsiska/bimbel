...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <a type="button" href="/sertifikat/create" class="btn btn-primary btn-rounded btn-fw"
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ asset('storage/'. $posta->sertifikat) }}">Lihat Sertifikat<a></td> 
                                                    <td>

                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                <a class="edit"
                                                                    href='/sertifikat/{{ $posta['id']}}/edit'><i
                                                                        class="fa fa-pencil"></i></a>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <form action="/sertifikat/{{ $posta->id }}" class="d-inline" method="post">
                                                                    @method('delete')
                                                                    @csrf

...
<div class="form-group row">
   ...
   <div class="form-group row">
    ...
    <a href="" onclick="this.href='/kelas/laporan-berdasarkan/'+ document.getElementById('berdasarkan').value + '/' + 
    document.getElementById('isinya').value" target="_blank" class="btn tbn-primary col-md-12">cetak laporan</a>
</form>
<br>
 <a href="" onclick="this.href='/kelas/laporan-all/'" target="_blank" class="btn tbn-primary col-md-12">cetak laporan Lengkap</a>
<div class="container">

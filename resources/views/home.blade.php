        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="service-bx">  
                        <div class="action-box">
                            <img src="{{ asset('assets/dashboard/images/our-services/pic1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="service-bx">
                        <div class="action-box">
                            <img src="{{ asset('assets/dashboard/images/our-services/pic2.jpg')}}" alt="">
                        </div>
                        <div class="info-bx text-center">
                            <div class="feature-box-sm radius bg-white">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="service-bx m-b0">
                        <div class="action-box">
                            <img src="{{ asset('assets/dashboard/images/our-services/pic3.jpg')}}" alt="">
                        </div>
                        <div class="info-bx text-center">
                            <div class="feature-box-sm radius bg-white">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 heading-bx left">
                    <h2 class="title-head">Layanan Terbaik <span>dengan Fasilitas Lengkap</span></h2>
                    <p style="max-width:100%">Kami memiliki layanan yang baik dan lengkap, diantaranya :
                        Psikologi,
                        Akademik,
                        Fisik,
                        Mental Ideologi,
                        Materi SKD : TKP, TIU, TWK (khusus kedinasan),<br>
                        Dengan materi akurasi lebih dari 80%</p>
                </div>
            </div>

            ...
            <ul>
                ...
                <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
                    ...
                    <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-3"
                        ...
                        Layanan Terbaik Dengan Fasilitas Lengkap
                    </div>
                ...
                <li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default"
                    ...
                    <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-200-layer-4"
                        ...
                        data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                        style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
                        Wujudkan Cita-Cita Menjadi Abdi Negara bersama NEC
                    </div>
                    <!-- LAYER NR. 4 -->
        ...
        <div class="container">
             <div class="row">
                 <div class="col-lg-6 m-b30">
                    <h2 class="title-head ">Visi<span class="text-primary"> Kami</span></h2>
                    <h4><span class="counter">Visi </span> Najmi Edu Center</h4>
                    <p>Menjadi lembaga pendidikan dan Pelatihan Profesional dan terpadu yang menghasilkan peserta didik cerdas, Jasmani Unggul, dan sehat jiwa raga..</p>
                 ...
                 <div class="col-lg-6">
                     <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 m-b30">
                            <h2 class="title-head ">Misi <span class="text-primary">Kami</span></h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                            <div class="feature-container">
                                ...
                                <div class="icon-content">
                                    <h5 class="ttr-tilte">Misi 1</h5>
                                    <p>Menyiapkan peserta didik lolos seleksi TNI dan POLRI </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                            <div class="feature-container">
                                ...
                                <div class="icon-content">
                                    <h5 class="ttr-tilte">Misi 2.</h5>
                                    <p>Menata budaya kerja professional dan terpercaya</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                            ...
                            <div class="feature-container">
                                ...
                                <div class="icon-content">
                                    <h5 class="ttr-tilte">Misi 3.</h5>
                                    <p>Membina kerjasama dengan orang tua, masyarakat dan lembaga terkait.</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="events-details.html">Pengajar Lulusan
                                                        Terbaik</a></h4>

                                                <p>Seluruh guru lulusan terbaik dari PTN dan Sekolah Kedinasan favorit
                                                    yang sudah terseleksi ketat untuk menjamin kualitas pengajaran.
                                                    Garansi guru terbaik dan Profesional.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="#">Materi Lengkap dengan Kualitas
                                                        Terbaik
                                                    </a></h4>

                                                <p>Tersedia materi pembelajaran persiapan masuk sekolah kedinasan
                                                    lengkap dan terupdate. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="events-details.html">Kelas
                                                        Eksklusif</a></h4>

                                                <p>Pembelajaran dengan Kelas eksklusif yang sangat efektif sehingga
                                                    mampu memberikan pemahaman yang baik terhadap materi yang diajarkan.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="events-details.html">Report
                                                        Perkembangan Prestasi Belajar</a></h4>

                                                <p>Informasi kehadiran, nilai harian dan try out dilaporkan secara
                                                    berkala agar dapat lebih mudah menyusun strategi belajar demi meraih
                                                    Prestasi masuk Sekolah Kedinasan Impian</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="#">Coaching & Mentoring</a></h4>

                                                <p>Setiap siswa akan didampingi oleh Coach Profesional yang
                                                    menginspirasi sehingga siswa dengan sadar dapat memaksimalkan proses
                                                    belajar dan pengembangan potensi diri. Kegiatan mentoring dengan
                                                    para mentor yang kompeten dibidangnya membantu siswa meningkatkan
                                                    pemahaman untuk meraih prestasi akademik tertinggi lulus sekolah
                                                    kedinasan</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="event-bx">
                                        ...
                                        <div class="info-bx d-flex">
                                            ...
                                            <div class="event-info">
                                                <h4 class="event-title"><a href="events-details.html">Try Out berkala
                                                        dan Latihan Soal Harian
                                                    </a></h4>
                                                 
                                                <p>Latihan soal dan Try Out  HOTS dan update dilengkapi dengan pembahasan yang mudah kamu pahami.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
